...
const ProductSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'nametWords': IndexSchema(
      id: -7875931115582599920,
      name: r'nametWords',
      unique: false,
      replace: false,
      properties: [
...
int _productEstimateSize(
  ...
  bytesCount += 3 + object.nametWords.length * 3;
  {
    for (var i = 0; i < object.nametWords.length; i++) {
      final value = object.nametWords[i];
...
void _productSerialize(
  ...
  writer.writeStringList(offsets[2], object.nametWords);
...
extension ProductQueryWhere on QueryBuilder<Product, Product, QWhereClause> {
  ...
  QueryBuilder<Product, Product, QAfterWhereClause> nametWordsEqualTo(
      List<String> nametWords) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'nametWords',
        value: [nametWords],
      ));
    });
  }

  QueryBuilder<Product, Product, QAfterWhereClause> nametWordsNotEqualTo(
      List<String> nametWords) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition>
      nametWordsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'nametWords',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition>
      nametWordsElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'nametWords',
        value: value,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition>
      nametWordsElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'nametWords',
        wildcard: pattern,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> nametWordsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> nametWordsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'nametWords',
        0,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> nametWordsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'nametWords',
        0,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> nametWordsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByNametWords() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'nametWords');
    });
  }
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, List<String>, QQueryOperations> nametWordsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'nametWords');
    });
  }
